...
const assetCopies = [
  ...
  ['res/notes/01/notes.png', 'public/assets/mmw/notes_01.png'],
  ['res/notes/02/notes.png', 'public/assets/mmw/notes_02.png'],
  ['res/notes/01/longNoteLine.png', 'public/assets/mmw/longNoteLine.png'],
  ['res/notes/01/longNoteLine.png', 'public/assets/mmw/longNoteLine_01.png'],
  ['res/notes/02/longNoteLine.png', 'public/assets/mmw/longNoteLine_02.png'],
  ['res/notes/01/touchLine_eff.png', 'public/assets/mmw/touchLine_eff.png'],
  ['res/notes/01/touchLine_eff.png', 'public/assets/mmw/touchLine_eff_01.png'],
  ['res/notes/02/touchLine_eff.png', 'public/assets/mmw/touchLine_eff_02.png'],
